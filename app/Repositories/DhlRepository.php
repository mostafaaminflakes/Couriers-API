...
class DhlRepository implements CourierInterface
{
    public function metadata()
    {
        // Dummy.
        return response()->json(['name' => 'API: Courier: dhl', 'features' => ['create_shipment', 'void_shipment', 'shipment_status', 'track_shipment', 'create_waybill', 'print_waybill_label']]);
    }
