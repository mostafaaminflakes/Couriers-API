...
class AramexRepository implements CourierInterface
{
    public function metadata()
    {
        // Dummy.
        return response()->json(['name' => 'API: Courier: aramex', 'features' => ['create_shipment', 'void_shipment', 'shipment_status', 'track_shipment', 'create_waybill', 'print_waybill_label']]);
    }
